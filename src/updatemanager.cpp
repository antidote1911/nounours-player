...
bool UpdateManager::DownloadUpdate(const QString &url)
{
    ...
    QString filename = QDir::toNativeSeparators(QString("%0/Nounours-Player.zip").arg(QCoreApplication::applicationDirPath()));
...
void UpdateManager::ApplyUpdate(const QString &file)
{
    ...
    // create a temporary directory for nounours
    QString path = QDir::toNativeSeparators(QString("%0/.tmp/").arg(QCoreApplication::applicationDirPath()));
    QString exe = QDir::toNativeSeparators(QString("%0/Nounours Player.exe").arg(QCoreApplication::applicationDirPath()));
