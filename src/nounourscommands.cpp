...
void NounoursEngine::NounoursMpv(QStringList &args)
{
    if(!args.empty())
        mpv->Command(args);
    else
...
void NounoursEngine::NounoursSh(QStringList &args)
{
    if(!args.empty())
    {
...
void NounoursEngine::NounoursNew(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursOpenLocation(QStringList &args)
{
    if(args.empty())
        OpenLocation();
    else
...
void NounoursEngine::OpenLocation()
{
    mpv->LoadFile(LocationDialog::getUrl(mpv->getPath()+mpv->getFile(), window));
}


void NounoursEngine::NounoursOpenClipboard(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursShowInFolder(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursAddSubtitles(QStringList &args)
{
    QString trackFile;
    if(args.empty())
    {
...
void NounoursEngine::NounoursAddAudio(QStringList &args)
{
    QString trackFile;
    if(args.empty())
    {
...
void NounoursEngine::NounoursScreenshot(QStringList &args)
{
    if(args.empty())
        Screenshot(false);
    else
...
void NounoursEngine::Screenshot(bool subs)
{
...
void NounoursEngine::NounoursMediaInfo(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursStop(QStringList &args)
{
    if(args.empty())
        mpv->Stop();
    else
...
void NounoursEngine::NounoursPlaylist(QStringList &args)
{
    if(!args.empty())
    {
        QString arg = args.front();
        ...
        RequiresParameters("nounours playlist");
}

void NounoursEngine::NounoursJump(QStringList &args)
{
    if(args.empty())
        Jump();
    else
...
void NounoursEngine::NounoursDim(QStringList &args)
{
...
void NounoursEngine::Dim(bool dim)
{
    if(dimDialog == nullptr)
    {
...
void NounoursEngine::NounoursOutput(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursPreferences(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursOnlineHelp(QStringList &args)
{
    if(args.empty())
        QDesktopServices::openUrl(QUrl(tr("http://nounoursplayer.u8sand.net/help.php")));
    else
        InvalidParameter(args.join(' '));
}

void NounoursEngine::NounoursUpdate(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursOpen(QStringList &args)
{
    if(args.empty())
        Open();
    else
...
void NounoursEngine::NounoursPlayPause(QStringList &args)
{
    if(args.empty())
        PlayPause();
    else
...
void NounoursEngine::PlayPause()
{
    mpv->PlayPause(window->ui->playlistWidget->CurrentItem());
}


void NounoursEngine::NounoursFitWindow(QStringList &args)
{
    if(args.empty())
        FitWindow();
    else
...
void NounoursEngine::FitWindow(int percent, bool msg)
{
...
void NounoursEngine::NounoursDeinterlace(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursInterpolate(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursMute(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursVolume(QStringList &args)
{
    if(!args.empty())
    {
        QString arg = args.front();
...
void NounoursEngine::NounoursSpeed(QStringList &args)
{
    if(!args.empty())
    {
        QString arg = args.front();
...
void NounoursEngine::NounoursFullScreen(QStringList &args)
{
    if(args.empty())
    {
...
void NounoursEngine::NounoursHideAllControls(QStringList &args)
{
    if(args.empty())
    {
...
void NounoursEngine::NounoursBoss(QStringList &args)
{
    if(args.empty())
    {
        mpv->Pause();
...
void NounoursEngine::NounoursClear(QStringList &args)
{
    if(args.empty())
...
void NounoursEngine::NounoursHelp(QStringList &args)
{
    if(args.empty())
    {
        Print(tr("usage: nounours <command> [...]"));
        Print(tr("commands:"));
        int len, max_len = 22;
        for(auto command = NounoursCommandMap.begin(); command != NounoursCommandMap.end(); ++command)
        {
    ...
    else
    {
        ...
        if(args.empty())
        {
            auto command = NounoursCommandMap.find(arg);
            if(command != NounoursCommandMap.end()) //found
            {
...
void NounoursEngine::NounoursAbout(QStringList &args)
{
    About(args.join(' '));
}

void NounoursEngine::NounoursMsgLevel(QStringList &args)
{
    if(!args.empty())
    {
        QString arg = args.front();
...
void NounoursEngine::NounoursQuit(QStringList &args)
{
    if(args.empty())
        Quit();
    else
